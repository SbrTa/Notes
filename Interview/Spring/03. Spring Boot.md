...
Spring: It is a comprehensive framework providing a wide range of functionalities for building enterprise applications. It includes various modules like Spring Core, Spring AOP, Spring Data, Spring Security, and more. Developers need to configure the application context and manage dependencies manually.

Spring Boot: It is a project within the larger Spring ecosystem that focuses on simplifying the development of production-ready applications. It introduces convention-over-configuration principles, reducing the need for extensive setup and boilerplate code. Spring Boot provides defaults and auto-configuration to enhance developer productivity.
...
@ComponentScan: Scans for Spring components (e.g., controllers, services) in the specified packages.
...
Official documentation link: Spring Boot Auto-Configuration
...
Create separate application-{environment}.properties or application-{environment}.yml files.
Example: application-dev.properties, application-prod.properties.
Environment Properties:

Use environment-specific properties in the main application.properties or application.yml.
Example:
