...
KRaft eliminates the Zookeeper dependency, boosting scalability, stability, and administration simplicity. Production-ready since Kafka 3.3.1, KRaft will be the sole support in Kafka 4.0.
